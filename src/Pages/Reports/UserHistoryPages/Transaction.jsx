...
import HistoryLoad from '../../../SubPages/UserHistory/TransactionHistoryLoad'
...
const Transaction = () => {
  ...
  const handleTransactionResetBtnClick = () => {
    setCurrentPage(null);
    setIsLoaded(false);
      ...
      <div className="container-fluid">
        <div className="row search-bar">
          <div className="col-md-10 search-form">
            ...
            <button className="btn btn-black" onClick={handleTransactionLoadClick} type="submit">Load</button>
            <button className="btn btn-grey" type="submit" onClick={handleTransactionResetBtnClick}>Reset</button>
