...
import HistoryLoad from '../../../SubPages/UserHistory/ChangePassHistoryLoad'
...
const ChangePassword = () => {
  ...
  const handleChangePassLoadClick = () => {
    setIsLoading(true);
    setTimeout(() => {
      setIsLoading(false);
      setIsLoaded(true);
  ...
  const handleChangePassResetBtnClick = () => {
    setCurrentPage(null);
    setIsLoaded(false);
      ...
      <div className="container-fluid">
        <div className="row search-bar">
          <div className="col-md-6 search-form">
            ...
            <button className="btn btn-black" onClick={handleChangePassLoadClick} type="submit">Load</button>
            {isLoading && <Loader />}
            <button className="btn btn-grey" type="submit" onClick={handleChangePassResetBtnClick}>Reset</button>
