...
import HistoryLoad from '../../../SubPages/UserHistory/DepositeWithdrawalHistoryLoad'
...
const DepositeWithdrawal = () => {
  ...
  const handleDepositeWithdrawalLoadClick = () => {
    setIsLoading(true);
    setTimeout(() => {
      setIsLoading(false);
      setIsLoaded(true);
  ...
  const handleDepositeWithdrawalResetBtnClick = () => {
    setCurrentPage(null);
    setIsLoaded(false);
      ...
      <div className="container-fluid">
        <div className="row search-bar">
          <div className="col-md-10 search-form">
            ...
            <button className="btn btn-black" onClick={handleDepositeWithdrawalLoadClick} type="submit">Load</button>
            <button className="btn btn-grey" type="submit" onClick={handleDepositeWithdrawalResetBtnClick}>Reset</button>
                  ...
                  <thead>
                    <tr>
                      <th role="columnheader"  >
                        <div>Deposite History</div>
                      </th>

                      <th role="columnheader"  >
                        <div>Deposite Date</div>
                      </th>

                      <th role="columnheader"  >
                        <div>Deposite Time</div>
                      </th>

                      <th role="columnheader"  >
                        <div>All Withdrawal Request </div>
                      </th>

                      <th role="columnheader"  >
                        <div>Update History Status</div>
                      </th>
                    </tr>
                  </thead>
...
export default DepositeWithdrawal
