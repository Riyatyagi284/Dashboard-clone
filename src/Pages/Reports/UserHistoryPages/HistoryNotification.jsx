...
import HistoryLoad from '../../../SubPages/UserHistory/NotificationHistoryLoad'
...
const HistoryNotify = () => {
  ...
  const handleNotificationLoadClick = () => {
    setIsLoading(true);
    setTimeout(() => {
      setIsLoading(false);
      setIsLoaded(true);
  ...
  const handleNotificationResetBtnClick = () => {
    setCurrentPage(null);
    setIsLoaded(false);
      ...
      <div className="container-fluid">
              <div className="row search-bar">
                <div className="col-md-10 search-form">
                  ...
                  <button className="btn btn-black" onClick={handleNotificationLoadClick} type="submit">Load</button>
                  <button className="btn btn-grey" type="submit" onClick={handleNotificationResetBtnClick}>Reset</button>
