...
import HistoryLoad from '../../../SubPages/UserHistory/OrderPurchaseHistoryLoad'
...
const OrderPurchase = () => {
  ...
  const handleOrderPurchaseLoadClick = () => {
    setIsLoading(true);
    setTimeout(() => {
      setIsLoading(false);
      setIsLoaded(true);
  ...
  const handleOrderPurchaseResetBtnClick = () => {
    setCurrentPage(null);
    setIsLoaded(false);
      ...
      <div className="container-fluid">
              <div className="row search-bar">
                <div className="col-md-10 search-form">
                  ...
                  <button className="btn btn-black" onClick={handleOrderPurchaseLoadClick} type="submit">Load</button>
                  <button className="btn btn-grey" type="submit" onClick={handleOrderPurchaseResetBtnClick}>Reset</button>
