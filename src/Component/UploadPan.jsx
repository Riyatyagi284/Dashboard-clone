...
function Example() {
  ...
  return (
    <>
      <img src={profileImageShow.length ? (profileImageShow) : ("https://www.thestatesman.com/wp-content/uploads/2019/07/pan-card.jpg")}
      ...
      >
        ...
        aadharEnlarged && (
          <div onClick={toggleAadharEnlarged}>
            <img
              src={profileImageShow.length ? (profileImageShow) : ("https://www.thestatesman.com/wp-content/uploads/2019/07/pan-card.jpg")}
